            ...
            <div className="container px-4 mx-auto">
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full md:w-1/2 px-4">
                        <h2 className="mb-12 text-4xl md:text-5xl leading-tight  tracking-tighter">
                            Gain more insight into how people use your
                        </h2>
                        <div className="flex flex-wrap -mx-4 text-center md:text-left">
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                <div className="inline-flex items-center justify-center mb-4 w-12 h-12 text-xl text-white bg-black-pearl-900 font-semibold rounded-full">
                                    1
                                </div>
                                <h3 className="mb-2 text-xl ">Custom analytics</h3>
                            ...
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                ...
                                <h3 className="mb-2 text-xl ">Team Management</h3>
                                <p className="font-medium text-coolGray-500">
                            ...
                            <div className="w-full md:w-1/2 px-4 mb-8">
                                ...
                                <h3 className="mb-2 text-xl ">Easy setup</h3>
                                <p className="font-medium text-coolGray-500">
                            ...
                            <div className="w-full md:w-1/2 px-4">
                                ...
                                <h3 className="mb-2 text-xl ">Build your website</h3>
                                <p className="font-medium text-coolGray-500">
